...
namespace NClass.DiagramEditor.Diagrams.Connections
{
    public abstract class RoutedConnection : AbstractConnection
    {
        ...
        protected override void ShapeMoving(object sender, MoveEventArgs e)
        {
            Reroute();
            OnRouteChanged(EventArgs.Empty);
            base.ShapeMoving(sender, e);
        }

        protected override void StartShapeResizing(object sender, ResizeEventArgs e)
        {
            ...
            Reroute();
            OnRouteChanged(EventArgs.Empty);
            base.StartShapeResizing(sender, e);
        }

        protected override void EndShapeResizing(object sender, ResizeEventArgs e)
        {
            ...
            Reroute();
            OnRouteChanged(EventArgs.Empty);
            base.EndShapeResizing(sender, e);
        }
            ...
            Shape first, Shape second)
        {
            if (CloneRelationship(diagram, first, second))
            {
                ...
                var connection = (RoutedConnection)connectionList.FirstValue;
        ...
        protected override void OnDeserializing(SerializeEventArgs e)
        {
            ...
            {
                bool.TryParse(oldStartNode.GetAttribute("isHorizontal"), out var isHorizontal);
                ...
                int.TryParse(oldStartNode.GetAttribute("location"), out var startLocation);
                int.TryParse(oldEndNode.GetAttribute("location"), out var endLocation);
