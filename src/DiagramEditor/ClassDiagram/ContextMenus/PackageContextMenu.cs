...
namespace NClass.DiagramEditor.ClassDiagram.ContextMenus
{
    ...
    {
        static PackageShapeContextMenu _default = new PackageShapeContextMenu();
        ...
        public static PackageShapeContextMenu Default
        {
            get { return _default; }
        }
        ...
        {
            mnuEditPackage.Text = Strings.MenuEditPackage;
        }
