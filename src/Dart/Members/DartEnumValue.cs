...
{
    internal sealed class DartEnumValue : EnumValue
    {
        // <name> [= value]
        const string EnumNamePattern = "(?<name>" + DartLanguage.NamePattern + ")";
        ...
        /// </exception>
        internal DartEnumValue(string declaration) : base(declaration)
        {
        }
      ...
      protected override EnumValue Clone()
        {
            return new DartEnumValue(GetDeclaration());
        }
    }
}
